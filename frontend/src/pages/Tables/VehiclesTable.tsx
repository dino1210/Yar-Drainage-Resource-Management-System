...
export default function VehiclesTable() {
  ...
  const handleOpenDeleteModal = (vehicle_id: number, name: string) => {
    setSelectedId(vehicle_id);
  ...
  const currentVehicles = filteredTools.slice(
                  ...
                  <TableRow key={vehicle.vehicle_id}>
                    ...
                    <TableCell className="px-8 py-3 text-xs text-gray-500 dark:text-gray-400 text-center">
                      <div className="flex items-center justify-center space-x-2 w-full h-full">
                        ...
                        <button
                          onClick={() =>
                            handleOpenDeleteModal(vehicle.vehicle_id, vehicle.name)
                          }
